...
const EditClothes = () => {
    ...
    const { handleEditSlide, loading, updateClothes, singleClothes, editSlide } = useClothesContext()
    ...
    useEffect(() => {
        ...
        if (!loading) {
            ...
            setValue("category", { value: singleClothes?.category, label: singleClothes?.category } || {});
            setValue("type", { value: singleClothes?.type, label: singleClothes?.type } || {});
            setValue("size", singleClothes?.size.map(size => ({ value: size, label: size })) || []);
            setValue("color", singleClothes?.color.map(color => ({ value: color, label: color })) || []);
    ...
    return (
        <div className={editSlide ? "clothes-form overflow-x-hidden" : "clothes-form open-form overflow-x-hidden"}>
            <button className="close-btns" onClick={handleEditSlide}>
